...
async def run_test():
    ...
    try:
        ...
        # -> Fill in the email and password fields and submit the sign-in form to log into the dashboard.
        ...
        # -> Click the 'Inventaris' navigation link to open the inventory page and locate the product list.
        frame = context.pages[-1]
        # Click element
